...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_17_FOUNDER_PAYMENT_ENFORCEMENT) r = SPORK_17_FOUNDER_PAYMENT_ENFORCEMENT_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_17_FOUNDER_PAYMENT_ENFORCEMENT") return SPORK_17_FOUNDER_PAYMENT_ENFORCEMENT_DEFAULT;
    return -1;
}
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_17_FOUNDER_PAYMENT_ENFORCEMENT) return "SPORK_17_FOUNDER_PAYMENT_ENFORCEMENT";
    return "Unknown";
}
